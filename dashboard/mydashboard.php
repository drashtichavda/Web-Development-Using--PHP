        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <nav id="sidebar" class="col-md-3">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item"><a href="https://sites.google.com/view/drashti-chavda" target="_blank">Google Site</a></li>
                        <li class="list-group-item">LinkedIn</li>
      
                        <li class="list-group-item"><a href="https://github.com/drashtichavda/Web-Development-Using--PHP" target="_blank">GitHub</a></li>
                    </ul>
                </nav>
                <!-- Main content -->
                <main class="col-md-9">
                    <div id="header">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <h1>drashti chavda</h1>
                                </div>
                                <div class="col-md-6">
                                        <img src="logo.png" alt="Logo" width="100" class="float-right rounded-custom">
                                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="dashboard-item">
                            ...
                            <div class="btn-group">
                                <button class="ocean-blue-button gradient-button"><a href="https://github.com/drashtichavda/Web-Development-Using--PHP/tree/main/task-1" target="_blank">Task 1</a></button>
    <button class="sunset-orange-button gradient-button"><a href="https://github.com/drashtichavda/Web-Development-Using--PHP/tree/main/task2" target="_blank"> Task 2</a></button>
    <button class="spring-green-button gradient-button"><a href="https://github.com/drashtichavda/Web-Development-Using--PHP/tree/main/Task%203" target="_blank">Task 3</a></button>
